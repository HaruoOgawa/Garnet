...
namespace api
{
	...
	std::shared_ptr<graphics::CMaterial> COpenGLAPI::CreateMaterial(const std::shared_ptr<graphics::CMaterialCreateInfo>& createInfo, int RefCount)
	{
		auto Material = std::make_shared<api::COpenGLMaterial>(this, createInfo, RefCount);
