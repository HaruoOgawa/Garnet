...
namespace graphics
{
	CPostProcessBloom::CPostProcessBloom(const std::string& TargetPassName):
	...
	CPostProcessBloom::~CPostProcessBloom()
	{
	}

	bool CPostProcessBloom::Initialize(api::IGraphicsAPI* pGraphicsAPI, resource::CLoadWorker* pLoadWorker)
	{
		// オフスクリーンレンダーパス
	...
	bool CPostProcessBloom::Update(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker, const std::shared_ptr<camera::CCamera>& Camera,
	...
	bool CPostProcessBloom::Draw(api::IGraphicsAPI* pGraphicsAPI, const std::shared_ptr<camera::CCamera>& Camera, const std::shared_ptr<projection::CProjection>& Projection,
