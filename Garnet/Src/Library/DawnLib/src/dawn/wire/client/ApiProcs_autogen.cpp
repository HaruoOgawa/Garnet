...
namespace dawn::wire::client {
    ...
    void ClientRenderPassEncoderPixelLocalStorageBarrier(WGPURenderPassEncoder cSelf) {
        auto self = reinterpret_cast<RenderPassEncoder*>(cSelf);
    ...
    namespace {
        ...
        static const ProcEntry sProcMap[] = {
            ...
            { reinterpret_cast<WGPUProc>(ClientRenderPassEncoderPixelLocalStorageBarrier), "wgpuRenderPassEncoderPixelLocalStorageBarrier" },
    ...
    static DawnProcTable gProcTable = MakeProcTable(
        ...
        , std::make_pair(&DawnProcTable::renderPassEncoderPixelLocalStorageBarrier, ClientRenderPassEncoderPixelLocalStorageBarrier)
