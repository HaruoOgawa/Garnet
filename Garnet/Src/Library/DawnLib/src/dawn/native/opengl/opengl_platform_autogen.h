...
using PFNGLGETSYNCIVPROC = void(KHRONOS_APIENTRY *)(GLsync sync, GLenum pname, GLsizei count, GLsizei * length, GLint * values);
...
using PFNGLGETINTERNALFORMATIVPROC = void(KHRONOS_APIENTRY *)(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint * params);
...
using PFNGLGETPROGRAMRESOURCEIVPROC = void(KHRONOS_APIENTRY *)(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei count, GLsizei * length, GLint * params);
...
using PFNGLGETINTERNALFORMATI64VPROC = void(KHRONOS_APIENTRY *)(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64 * params);
