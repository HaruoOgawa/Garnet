...
namespace gltf
{
	...
	private:
		...
		static bool RecalculateTangentWithUINT(std::vector<float>& TangentData, std::vector<float>& BioTangentData, const std::vector<float>& PosotionData, const std::vector<float>& TexcoordData, const std::vector<unsigned int>& Indices);
	public:
