...
{
	class CIndirectLightComponent : public scriptable::CComponent
	{
	...
	public:
		CIndirectLightComponent(const std::string& ComponentName, const std::string& RegistryName);
		virtual ~CIndirectLightComponent();
