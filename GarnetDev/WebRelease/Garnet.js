...
var ASM_CONSTS = {
  233020: ($0, $1, $2, $3) => { const w0 = Module.UTF16ToString($0); const w1 = Module.UTF16ToString($1); const windex = $2; const nameCount = $3; return (w0 == w1[windex] && w1.length == nameCount) ? 1 : 0; },  
 233200: ($0, $1, $2, $3) => { const w0 = Module.UTF16ToString($0); const w1 = Module.UTF16ToString($1); const windex = $2; const nameCount = $3; return (w0 == w1[windex] && w1.length == nameCount) ? 1 : 0; },  
 233380: ($0) => { const fileName = Module.UTF8ToString($0); window.g3dCreateAudio(fileName); },  
 233459: ($0) => { const loop = ($0 != 0); window.g3dPlayAudio(loop); },  
 233514: ($0) => { const loop = ($0 != 0); window.g3dPlayAudio(loop); },  
 233569: () => { window.g3dStopAudio(); },  
 233596: () => { return window.g3dIsAudioPlaying(); }
};
