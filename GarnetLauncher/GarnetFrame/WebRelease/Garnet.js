...
var ASM_CONSTS = {
  217612: ($0, $1, $2, $3) => { const w0 = Module.UTF16ToString($0); const w1 = Module.UTF16ToString($1); const windex = $2; const nameCount = $3; return (w0 == w1[windex] && w1.length == nameCount) ? 1 : 0; },  
 217792: ($0, $1, $2, $3) => { const w0 = Module.UTF16ToString($0); const w1 = Module.UTF16ToString($1); const windex = $2; const nameCount = $3; return (w0 == w1[windex] && w1.length == nameCount) ? 1 : 0; },  
 217972: ($0) => { const fileName = Module.UTF8ToString($0); window.g3dCreateAudio(fileName); },  
 218051: ($0) => { const loop = ($0 != 0); window.g3dPlayAudio(loop); },  
 218106: ($0) => { const loop = ($0 != 0); window.g3dPlayAudio(loop); },  
 218161: () => { window.g3dStopAudio(); },  
 218188: () => { return window.g3dIsAudioPlaying(); }
};
